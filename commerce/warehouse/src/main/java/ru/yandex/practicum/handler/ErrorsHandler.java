...
import ru.yandex.practicum.exceptions.ProductAlreadyInWarehouseException;
...
public class ErrorsHandler {
    ...
    @ExceptionHandler({
            ProductNotFoundInWarehouseException.class,
            ProductLowQuantityInWarehouseException.class,
            ProductAlreadyInWarehouseException.class
    })
